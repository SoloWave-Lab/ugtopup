    ...
    <section className="py-6 md:py-8 bg-background">
      <div className="container mx-auto px-4">
        <div className="flex flex-col items-center justify-center space-y-3 text-center">
          {/* Best Deals Title */}
          <h2 
            className="flex items-center justify-center gap-2 text-xl md:text-2xl font-bold tracking-wider"
          ...
          <div 
            className="flex items-center justify-center gap-1.5 md:gap-2 text-base md:text-xl font-semibold text-foreground/90"
            role="status"
